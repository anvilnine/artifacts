...
export function pdfViewerFlags(settings) {
  ...
  if (!download) {
    ...
    // The side panel goes; the toolbar stays. It holds the page counter and the prev/next of a
    // multi-page deck, and there is no way to build our own: an <object> holding a PDF exposes
